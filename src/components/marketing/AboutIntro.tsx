      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="max-w-prose">
          ...
          <p className="mt-4 text-body">
            ZerodhaRebuild reproduces those mechanics against real market prices with nothing at
            ...
            database rather than in application code, and a realtime price pipeline built entirely
            on infrastructure that costs nothing to run.
          </p>
        </div>
      </div>
    </section>
